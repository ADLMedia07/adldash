...
client.on("ready", () => {  console.log(`[ADLMedia] ${client.user.username} ismi ile çalışıyorum!`);
  client.user.setStatus("ONLINE")
  client.user.setGame("By ADLMedia");
...
client.ayar = db;
client.config = require("./adlmediacnfg.js");
client.ayarlar = require("./adlmediacnfg.js")

dcc.ayar = db;
dcc.config = require("./adlmediacnfg.js");
dcc.ayarlar = require("./adlmediacnfg.js")
